            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    const Color.fromARGB(25, 92, 94, 103),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'El interés compuesto es el que se va sumando al capital inicial y sobre el que se van generando nuevos intereses. Esto significa que los intereses generados en cada período se reinvierten, aumentando así el capital sobre el cual se calculan los intereses futuros. En otras palabras, es "interés sobre interés", lo que puede llevar a un crecimiento exponencial de la inversión o deuda a lo largo del tiempo.',
                    style: TextStyle(
                    ...
                    children: [
                      ...
                      TextButton.icon(
                        ...
                        label: Text(
                          'Limpiar',
                          style: TextStyle(
                            color: const Color.fromARGB(255, 92, 194, 225),
                            fontWeight: FontWeight.bold,
                          ),
                        ),
                      ...
                      Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            borderRadius: BorderRadius.circular(10),
                            dropdownColor:
                                Colors.white, // <-- Color de fondo del menú
                            items:
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color.fromARGB(255, 22, 5, 206),
